            ...
            <div className="container" >
                <div className='card border-success' style={{ marginTop: "5%" }} >
                    <div className="col-md-12 padding0px bg-success rounded-top">
                            ...
                            <h4 className="text" style={{paddingTop:"1%",color:"white"}}>Required Documents to Upload and Details:</h4>
                        
                    </div>
                    <div className='upload' style={{ marginTop: "3%" }}>

                        {/* <div className="mb-3" style={{ width: "40%" }}>
                            <label for="formFile" className="form-label">Location to Open</label>
                            <input className="form-control" type="text" name='location' id="formFile location" onChange={onChangeFiles}  required/>
                        </div> */}
